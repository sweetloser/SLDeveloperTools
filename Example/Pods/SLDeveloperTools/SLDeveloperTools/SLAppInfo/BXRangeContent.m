...
- (id)init
{
    if (self = [super init]) {
        ...
        _borderHeight = 0.5;
        _leftPinImage = [UIImage imageNamed:@"video_left"];
        _centerPinImage = [UIImage imageNamed:@"center_1"];
        _rightPigImage = [UIImage imageNamed:@"video_right"];
    }
...
@interface BXRangeContent()

@end

@implementation BXRangeContent {
    CGFloat _imageWidth;
...
- (void)iniSubViews
{
    ...
    if (_appearanceConfig.leftCorverImage) {
        ...
        self.leftCover.backgroundColor = sl_normalColors;
        self.leftCover.alpha = 0.3;
    };
    self.leftCover.layer.cornerRadius = 4;
    ...
    if (_appearanceConfig.rightCoverImage) {
        ...
        self.rightCover.backgroundColor = sl_normalColors;
        self.rightCover.alpha = 0.3;
    }
    self.rightCover.layer.cornerRadius = 4;
    ...
    self.topBorder = ({
        UIView *view = [[UIView alloc] initWithFrame:CGRectZero];
        [self addSubview:view];
        view.backgroundColor = sl_normalColors;
        view;
    });
