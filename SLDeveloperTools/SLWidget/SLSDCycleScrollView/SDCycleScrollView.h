...
// scrollview代理
- (void)cycleScrollViewDidEndDecelerating:(UIScrollView *)scrollView;

- (void)cycleScrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate;

- (void)cycleScrollViewDidScrollToTop:(UIScrollView *)scrollView;
