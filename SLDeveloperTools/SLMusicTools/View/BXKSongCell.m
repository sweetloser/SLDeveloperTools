...
@interface BXKSongCell()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
@property (nonatomic,strong) UICollectionView *collectionView;
@property (nonatomic,assign) NSInteger allNum;

@end

@interface DSKSongScrollViewCell : UICollectionViewCell
/** 音乐图片 */
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.collectionView registerClass:[DSKSongScrollViewCell class] forCellWithReuseIdentifier:@"DSKSongScrollViewCell"];
...
{
    DSKSongScrollViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"DSKSongScrollViewCell" forIndexPath:indexPath];
    ...
    [cell setSeleIndexPath:^(NSInteger tag) {
        @strongify(self);
        if (self.likeSongBlock) {
            self.likeSongBlock(tag);
        }
    }];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DSKSongScrollViewCell *cell = (DSKSongScrollViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
...
@implementation DSKSongScrollViewCell
