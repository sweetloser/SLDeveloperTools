...
@interface BXCommentView ()<UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate, BXCommentFooterViewDelegate>
...
- (void)createHeadFootViewWithCommentCount:(NSString *)commentCount{
    ...
    textFieldBtn.backgroundColor = [UIColor sl_colorWithHex:0x1E1E20];
...
- (void)createTableView{
    ...
    [self.tableView registerClass:[BXCommentFooterView class] forHeaderFooterViewReuseIdentifier:@"Footer"];
...
- (void)loadChildCommentDataWithComment:(BXCommentModel *)comment Section:(NSInteger)section view:(BXCommentFooterView *)view {
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    BXCommentModel *model = self.commentArray[indexPath.section];
    BXCommentModel *replyModel =  model.childCommentArray[indexPath.row];
    BXCommentCell *cell = (BXCommentCell *)[tableView dequeueReusableCellWithIdentifier:@"BXCommentCell"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    BXCommentHeaderView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"BXCommentHeaderView"];
    WS(ws);
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    BXCommentModel *model = self.commentArray[section];
    if ([model.reply_count integerValue] > 1 && model.childCommentArray.count) {
        BXCommentFooterView *footerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"Footer"];
