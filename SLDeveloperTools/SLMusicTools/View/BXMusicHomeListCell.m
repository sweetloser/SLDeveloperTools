...
@interface BXMusicHomeListCell()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@interface DSMusicHomeListScrollViewCell : UICollectionViewCell
/** 音乐图片 */
...
@implementation BXMusicHomeListCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.collectionView registerClass:[DSMusicHomeListScrollViewCell class] forCellWithReuseIdentifier:@"DSMusicHomeListScrollViewCell"];
        [self addObserver];
    }
    return self;
}
...
{
    DSMusicHomeListScrollViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"DSMusicHomeListScrollViewCell" forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DSMusicHomeListScrollViewCell *cell = (DSMusicHomeListScrollViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
...
@implementation DSMusicHomeListScrollViewCell
...
-(void)setModels:(BXMusicModel *)models{
    _models = models;
    [self.iconImageView yy_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",models.image]] placeholder:[UIImage imageNamed:@""]];
