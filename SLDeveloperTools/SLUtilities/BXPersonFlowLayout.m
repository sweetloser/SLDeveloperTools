...
@interface BXPersonFlowLayout(){
    //在居中对齐的时候需要知道这行所有cell的宽度总和
    CGFloat _sumCellWidth ;
}
@end
@implementation BXPersonFlowLayout
-(instancetype)init{
...
-(void)setLeftBounce:(CGFloat)leftBounce{
    _leftBounce = leftBounce;
}
-(void)setRightBounce:(CGFloat)rightBounce{
    _rightBounce = rightBounce;
}
