...
@interface BXDynCircleHomeVC ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate, BXDynBaseCellDelegate,playDelegate>
...
@implementation BXDynCircleHomeVC
...
-(void)getData:(dispatch_group_t)group{
    ...
    [HttpMakeFriendRequest GetCircleListWithcircle_id:self.model.circle_id page_index:[NSString stringWithFormat:@"%ld",(long)_page+1] page_size:@"20" extend_type:@"1" Success:^(NSDictionary * _Nonnull jsonDic, BOOL flag, NSMutableArray * _Nonnull models) {
