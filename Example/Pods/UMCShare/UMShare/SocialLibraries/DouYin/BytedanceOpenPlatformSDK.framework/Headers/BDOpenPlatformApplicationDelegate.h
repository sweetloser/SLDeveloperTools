...
@protocol BDOpenPlatformLogDelegate <NSObject>
...
@interface BDOpenPlatformApplicationDelegate : NSObject

@property (nonatomic, copy, readonly) NSString *currentVersion; //!< Open Platform SDK currtent version
@property (nonatomic, weak) id<BDOpenPlatformLogDelegate> logDelegate;//!< Open Platform internal log delegate
 ...
 */
- (NSString *)iTunesUrlWithType:(NSInteger)type;
 ...
 */
- (BOOL)registerAppId:(NSString *)appid type:(NSInteger)type;
 ...
 */
- (nullable NSString *)appIdWithType:(NSInteger)type;
 ...
 */
- (BOOL)isAppInstalledWithType:(NSInteger)type;
