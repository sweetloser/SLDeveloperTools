...
@interface BXDynTopicVideoVC ()<UICollectionViewDataSource, UICollectionViewDelegate,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
...
@implementation BXDynTopicVideoVC
...
-(void)createData{
    [HttpMakeFriendRequest TipTopicListWithpage_index:[NSString stringWithFormat:@"%ld",(long)_page+1] page_size:@"100" extend_type:@"2" topic_id:self.model.topic_id Success:^(NSDictionary * _Nonnull jsonDic, BOOL flag, NSMutableArray * _Nonnull models) {
