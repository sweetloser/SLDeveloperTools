...
- (CGRect)imageRectForContentRect:(CGRect)contentRect {
    ...
    switch (_style) {
        ...
        case LPButtonStyleLeft:{
            ...
            CGSize titleSize = [self lc_labelSizeWithText:self.titleLabel.text font:self.titleLabel.font size:CGSizeMake(CGFLOAT_MAX, CGFLOAT_MAX) lineSpacing:0.0];
            
            imageH = CGRectGetHeight(contentRect) - _delta * 2 - self.imageEdgeInsets.top - self.imageEdgeInsets.bottom;
            imageW = imageH;
            
            imageX = (CGRectGetWidth(contentRect) - titleSize.width - imageW - _space)/2.0;
            imageY = _delta + self.imageEdgeInsets.top;
        ...
        case LPButtonStyleRight:{
            ...
            imageX = (CGRectGetWidth(contentRect) - titleSize.width - imageW - _space)/2.0 + titleSize.width;
            imageY = _delta + self.imageEdgeInsets.top;
...
- (CGRect)titleRectForContentRect:(CGRect)contentRect {
    ...
    switch (_style) {
        ...
        case LPButtonStyleLeft:{
            CGSize titleSize = [self lc_labelSizeWithText:self.titleLabel.text font:self.titleLabel.font size:CGSizeMake(CGFLOAT_MAX, CGFLOAT_MAX) lineSpacing:0.0];
            CGFloat imageH = CGRectGetHeight(contentRect) - _delta * 2 - self.imageEdgeInsets.top - self.imageEdgeInsets.bottom;
            CGFloat imageW = imageH;
            
            titleX = (CGRectGetWidth(contentRect) - titleSize.width - imageW - _space)/2.0 + imageW + _space;
            titleY = _delta;
        ...
        case LPButtonStyleRight:{
            ...
            titleX = (CGRectGetWidth(contentRect) - titleSize.width - imageH - _space)/2.0;
            titleY = _delta;
