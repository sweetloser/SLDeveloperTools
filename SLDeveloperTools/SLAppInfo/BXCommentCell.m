...
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    ...
    BXCommentCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
...
- (void)createUI
{
    ...
    self.contentLabel.sd_layout.leftSpaceToView(self.headImageView, 8).topSpaceToView(self.nickNameBtn, 4).heightIs(20).widthIs(__kWidth-141);
