...
@implementation BXKSongTableViewCell
...
- (void)createUI{
    ...
    _musicLabel.frame = CGRectMake(80, 15, __kWidth-80-55, 19);
    _nameLabel = [UILabel initWithFrame:CGRectZero size:12 color:MinorColor alignment:NSTextAlignmentLeft lines:1];
    _nameLabel.frame = CGRectMake(80, 38, __kWidth-80-55, 16);
    _collectBtn = [[UIButton alloc]init];
    _collectBtn.frame = CGRectMake(__kWidth-39, 23.5, 23, 21);
    ...
    _useBtn.frame = CGRectMake(__kWidth, 18, 65, 32);
    _useBtn.titleLabel.font =  CFont(15);
    [_useBtn setTitle:@"演唱" forState:BtnNormal];
...
-(void)setModel:(BXMusicModel *)model{
    ...
    if (model.isSelect==NO) {
        ...
        self.musicLabel.frame = CGRectMake(80, 15, __kWidth-80-55, 19);
        self.nameLabel.frame = CGRectMake(80, 38, __kWidth-80-55, 16);
        self.collectBtn.frame = CGRectMake(__kWidth-39, 23.5, 23, 21);
        self.useBtn.frame = CGRectMake(__kWidth, 18, 65, 32);
    }else{
        self.useBtn.hidden = NO;
        self.playPauseImageView.image = [UIImage imageNamed:@"icon_music_pause"];
        self.musicLabel.frame = CGRectMake(80, 15, __kWidth-80-55-85, 19);
        self.nameLabel.frame = CGRectMake(80, 38, __kWidth-80-55-85, 16);
        self.collectBtn.frame = CGRectMake(__kWidth-39-85, 23.5, 23, 21);
        self.useBtn.frame = CGRectMake(__kWidth-11-85+15, 18, 65, 32);
    }
}
