...
- (void)scrollViewDidScrollToTop:(UIScrollView *)scrollView {
    if ([self.delegate respondsToSelector:@selector(cycleScrollViewDidScrollToTop:)]) {
        [self.delegate cycleScrollViewDidScrollToTop:scrollView];
    }
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if ([self.delegate respondsToSelector:@selector(cycleScrollViewDidEndDecelerating:)]) {
        [self.delegate cycleScrollViewDidEndDecelerating:scrollView];
    }
}
