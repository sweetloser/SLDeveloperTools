...
//                return;
//            }
            self.DidItemIndex([[self.topicDataArray[indexPath.section] objectForKey:@"data"][indexPath.row] objectForKey:@"topic_name"], [[self.topicDataArray[indexPath.section] objectForKey:@"data"][indexPath.row] objectForKey:@"topic_id"]);
...
//            titlelabel.textColor = [UIColor sl_colorWithHex:0x8C8C8C);
...
-(void)searchView{
    ...
    searchField.backgroundColor = [UIColor sl_colorWithHex:0xF5F9FC];
...
//    [self.searchBar setBackgroundColor:[UIColor sl_colorWithHex:0xF5F9FC]];
