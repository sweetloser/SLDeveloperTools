...
@interface BXKSongSearchResualtVC ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
@implementation BXKSongSearchResualtVC
