...
@property (nonatomic, strong) NSURL *placeURL;
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder placeholderURL:(NSURL *)placeurl
{
    if (_reloadButton) {
...
- (void)reloadImage
{
    [self setImageWithURL:_imageUrl placeholderImage:_placeHolderImage placeholderURL:_placeURL];
}
