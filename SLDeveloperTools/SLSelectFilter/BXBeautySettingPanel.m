...
@interface BXBeautySettingPanel() <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
{
...
@implementation BXBeautySettingPanel
...
- (void)commonInit
{
    ...
    //    NSArray *beautyStyleArray = @[L(@"BXBeautySettingPanel.BeautyTypeArray1"),
    //                                  L(@"BXBeautySettingPanel.BeautyTypeArray2"),
    //                                  L(@"BXBeautySettingPanel.BeautyTypeArray3")];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    if(collectionView == _menuCollectionView){
        BXTextCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:[BXTextCell reuseIdentifier] forIndexPath:indexPath];
...
{
    //    BXTextCell *cell = (BXTextCell *)[collectionView cellForItemAtIndexPath:indexPath];
...
- (NSString*)filterNameByIndex:(NSInteger)index {
...
- (NSString*)filterImageNameByIndex:(NSInteger)index {
    NSString *lookupFileName = nil;
...
- (UICollectionView *)optionsCollectionView {
    if (_optionsCollectionView == nil) {
        ...
        [_optionsCollectionView registerClass:[BXTextCell class] forCellWithReuseIdentifier:[BXTextCell reuseIdentifier]];
    }
...
- (UICollectionView *)menuCollectionView
{
    if(!_menuCollectionView){
        ...
        [_menuCollectionView registerClass:[BXTextCell class] forCellWithReuseIdentifier:[BXTextCell reuseIdentifier]];
    }
