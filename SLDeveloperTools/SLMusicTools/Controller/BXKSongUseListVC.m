...
@interface BXKSongUseListVC ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
@implementation BXKSongUseListVC
...
- (void)createData{
    [[NewHttpRequestHuang sharedNewHttpRequestHuang]MusicUseMusicListWithOffset:[NSString stringWithFormat:@"%ld",(long)_offSet] length:@"20" Success:^(id responseObject) {
